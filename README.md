...
- [에이전트 대화 샘플 PDF 다운로드](./assets/에이전트_대화_캡쳐.pdf)
   > 위 링크는 제출 시 함께 포함된 `assets/에이전트_대화_캡쳐.pdf` 파일을 참조합니다.
- [에이전트 여행 일정 공유 MD 다운로드](./assets/여행일정_공유.md)
   > 위 링크는 제출 시 함께 포함된 `assets/여행일정_공유.md` 파일을 참조합니다.
---